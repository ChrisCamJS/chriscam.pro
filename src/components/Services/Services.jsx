...
export default function Services() {
  ...
  const services = [
    ...
    { id: 8, title: 'Full-Stack Web App', price: 'Starts at $1,499', icon: <MonitorSmartphone className="w-8 h-8 text-primary" />, desc: 'React front-end paired with a robust PHP/MySQL backend (like The Pantry).' },
    { id: 9, title: 'Ongoing Maintenance', price: '$99/mo', icon: <Wrench className="w-8 h-8 text-primary" />, desc: 'Monthly tech support, updates, and backups so you can sleep soundly.' },
